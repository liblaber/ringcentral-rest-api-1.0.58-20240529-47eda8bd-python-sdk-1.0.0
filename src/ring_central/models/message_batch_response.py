...
class MessageBatchResponse(BaseModel):
    ...
    :param last_modified_time: The last time the batch was processed. , defaults to None
    ...
    :param creation_time: The time at which the batch was created , defaults to None
    ...
    :param cost: The estimated batch cost for completed batch. Calculated after batch processing is completed. , defaults to None
