...
class NotificationSettingsUpdateRequest(BaseModel):
    ...
    :param email_addresses: List of notification recipient email addresses. Should not be empty if 'includeManagers' parameter is set to false , defaults to None
    ...
    :param include_managers: Specifies if managers' emails are included in the list of emails to which notifications are sent. If not specified, then the value is `true` , defaults to None
