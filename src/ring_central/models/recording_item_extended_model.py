...
class RecordingItemExtendedModel(BaseModel):
    ...
    :param shared: Indicates if Host or Admin has shared a recording. Can be set to true only then recording status is 'Available'. , defaults to None
    ...
    :type session: SessionRefModel, optional
    """
    ...
    def __init__(
        ...
        if session is not None:
            self.session = self._define_object(session, SessionRefModel)
