...
class AccountLimits(BaseModel):
    ...
    :param free_soft_phone_lines_per_extension: Max number of free softphone phone lines per user extension , defaults to None
    :type free_soft_phone_lines_per_extension: int, optional
    :param meeting_size: Max number of participants in RingCentral meeting hosted by this account's user , defaults to None
    :type meeting_size: int, optional
    :param cloud_recording_storage: Meetings recording cloud storage limitation in Gb , defaults to None
    :type cloud_recording_storage: int, optional
    :param max_monitored_extensions_per_user: Max number of extensions which can be included in the list of users monitored for Presence , defaults to None
    :type max_monitored_extensions_per_user: int, optional
    :param max_extension_number_length: Max length of extension numbers of an account; the supported value is up to 8 symbols, depends on account type , defaults to None
