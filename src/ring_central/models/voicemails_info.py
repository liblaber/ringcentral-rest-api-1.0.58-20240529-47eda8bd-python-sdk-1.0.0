...
class VoicemailsInfo(BaseModel):
    ...
    :param advanced_email_addresses: List of recipient email addresses for voicemail notifications. Returned if specified, in both modes (advanced/basic). Applied in advanced mode only , defaults to None
    :type advanced_email_addresses: List[str], optional
    :param advanced_sms_email_addresses: List of recipient phone numbers for voicemail notifications. Returned if specified, in both modes (advanced/basic). Applied in advanced mode only , defaults to None
    :type advanced_sms_email_addresses: List[str], optional
    :param include_attachment: Indicates whether voicemail should be attached to email , defaults to None
    :type include_attachment: bool, optional
    :param include_transcription: Specifies whether to add voicemail transcription or not , defaults to None
    :type include_transcription: bool, optional
    :param mark_as_read: Indicates whether a voicemail should be automatically marked as read , defaults to None
