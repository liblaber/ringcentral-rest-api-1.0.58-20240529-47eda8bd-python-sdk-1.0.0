...
class ShippingAddressInfo(BaseModel):
    ...
    :param additional_customer_name: Name of an additional contact person. Should be specified for countries except the US, Canada, the UK and Australia. , defaults to None
    :type additional_customer_name: str, optional
    :param customer_email: Email of a primary contact person (receiver). Should be specified for countries except the US, Canada, the UK and Australia. , defaults to None
    :type customer_email: str, optional
    :param additional_customer_email: Email of an additional contact person. Should be specified for countries except the US, Canada, the UK and Australia. , defaults to None
    :type additional_customer_email: str, optional
    :param customer_phone: Phone number of a primary contact person (receiver). Should be specified for countries except the US, Canada, the UK and Australia , defaults to None
    :type customer_phone: str, optional
    :param additional_customer_phone: Phone number of an additional contact person. Should be specified for countries except the US, Canada, the UK & Australia. , defaults to None
    :type additional_customer_phone: str, optional
    :param street: Street address, line 1 - street address, P.O. box, company name, c/o , defaults to None
    :type street: str, optional
    :param street2: Street address, line 2 - apartment, suite, unit, building, floor, etc. , defaults to None
    ...
    :param tax_id: National taxpayer identification number. Should be specified for Brazil (CNPJ/CPF number) and Argentina (CUIT number). , defaults to None
