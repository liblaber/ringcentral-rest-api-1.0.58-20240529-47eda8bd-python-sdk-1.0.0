...
class ContactInfoCreationRequest(BaseModel):
    """Contact Information

    :param first_name: For User extension type only. Extension user first name , defaults to None
    :type first_name: str, optional
    :param last_name: For User extension type only. Extension user last name , defaults to None
    ...
    :param business_phone: Extension user contact phone number in [E.164](https://www.itu.int/rec/T-REC-E.164-201011-I) format , defaults to None
    :type business_phone: str, optional
    :param mobile_phone: Extension user mobile (**non** Toll Free) phone number in [E.164](https://www.itu.int/rec/T-REC-E.164-201011-I) (with '+' sign) format , defaults to None
    ...
    :param email_as_login_name: If `true` then contact email is enabled as login name for this user. Please note that email should be unique in this case. The default value is `false` , defaults to None
