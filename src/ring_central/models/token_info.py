...
class TokenInfo(BaseModel):
    ...
    :type expires_in: int
    :param refresh_token: OAuth refresh token (if issued) , defaults to None
    ...
    :param scope: The list of space separated application permissions (OAuth scopes)
    :type scope: str
    ...
    :param endpoint_id: Client application instance identifier that matches the value provided by the client, or generated by the server if a client has not provided this value , defaults to None
    ...
    :param session_expires_in: Remaining time in seconds until session expiration due to absolute timeout. Returned only if absolute session timeout is enforced , defaults to None
    :type session_expires_in: int, optional
    :param session_expiration_time: Absolute value of session expiration time in ISO date formatted string. Returned only if absolute session timeout is enforced , defaults to None
    :type session_expiration_time: str, optional
    :param session_id: OAuth session ID, defaults to None
    :type session_id: str, optional
    :param session_idle_timeout: Nominal value of session idle timeout in seconds. Returned only if idle session timeout is enforced , defaults to None
