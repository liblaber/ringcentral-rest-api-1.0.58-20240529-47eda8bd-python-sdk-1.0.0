...
class InviteeModel(BaseModel):
    ...
    :param role: The role of the webinar session participant/invitee. See also: [Understanding Webinar Roles](https://support.ringcentral.com/webinar/getting-started/understanding-ringcentral-webinar-roles.html)
    :type role: RcwRoleEnum
    :param original_role: The role of the webinar session participant/invitee. See also: [Understanding Webinar Roles](https://support.ringcentral.com/webinar/getting-started/understanding-ringcentral-webinar-roles.html)
    ...
    :param qna_blocked: Boolean to indicate if the participant was blocked from Q&A , defaults to None
    :type qna_blocked: bool, optional
    :param send_invite: Indicates if invite/cancellation emails was sent to this invitee.
