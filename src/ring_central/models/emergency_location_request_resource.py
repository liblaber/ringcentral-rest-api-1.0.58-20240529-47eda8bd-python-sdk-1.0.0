...
class EmergencyLocationRequestResource(BaseModel):
    ...
    :param visibility: Visibility of an emergency response location. If `Private` is set, then a location is visible only for restricted number of users, specified in `owners` array , defaults to None
