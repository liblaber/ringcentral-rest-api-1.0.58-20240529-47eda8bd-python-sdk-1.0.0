...
class CreateForwardingNumberRequest(BaseModel):
    ...
    :param device: Forwarding device information. Applicable for 'PhoneLine' type only. Cannot be specified together with 'phoneNumber' parameter , defaults to None
