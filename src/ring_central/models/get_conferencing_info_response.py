...
class GetConferencingInfoResponse(BaseModel):
    ...
    :param mode: Internal parameter specifying a conferencing engine , defaults to None
    :type mode: str, optional
    :param participant_code: Access code for any participant, defaults to None
    :type participant_code: str, optional
    :param phone_number: Primary conference phone number for user's home country returned in [E.164](https://www.itu.int/rec/T-REC-E.164-201011-I) format , defaults to None
    :type phone_number: str, optional
    :param support_uri: Link to a branded support page, defaults to None
    :type support_uri: str, optional
    :param tap_to_join_uri: Short URL leading to the service web page Tap to Join for audio conference bridge , defaults to None
    :type tap_to_join_uri: str, optional
    :param phone_numbers: List of multiple dial-in phone numbers to connect to audio conference service, relevant for the user's brand. Each number is given with the country and location information, in order to let the user choose less expensive way to connect to a conference. The first number in the list is a primary conference number, that is default and domestic , defaults to None
