...
class CompanyPhoneNumberInfo(BaseModel):
    ...
    :param status: Status of a phone number. If the value is 'Normal', the phone number is ready to be used. If the value is 'Pending' it is an external number not yet ported to RingCentral. , defaults to None
    ...
    :param usage_type: Usage type of phone number. Usage type of phone number. Numbers of 'NumberPool' type are not returned in phone number list requests , defaults to None
    :type usage_type: CompanyPhoneNumberInfoUsageType, optional
    :param temporary_number: Temporary phone number, if any. Returned for phone numbers in `Pending` porting status only , defaults to None
