...
class ExtensionCallerIdInfo(BaseModel):
    ...
    :param extension_name_for_outbound_calls: If `true`, then user first name and last name will be used as caller ID when making outbound calls from extension , defaults to None
