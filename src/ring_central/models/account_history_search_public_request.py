...
class AccountHistorySearchPublicRequest(BaseModel):
    ...
    :param event_time_from: The beginning of the time range to return records in ISO 8601 format in UTC timezone, default is "eventTimeFrom"-24 hours , defaults to None
    ...
    :param search_string: The (sub)string to search, applied to the following fields: - initiator.name - initiator.role - initiator.extensionNumber - target.name - target.extensionNumber - details.parameters.value, defaults to None
