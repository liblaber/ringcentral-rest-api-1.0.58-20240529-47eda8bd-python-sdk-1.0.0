...
class GrantInfo(BaseModel):
    ...
    :param call_pickup: Specifies if picking up of other extensions' calls is allowed for the extension. If 'Presence' feature is disabled for the given extension, the flag is not returned , defaults to None
    :type call_pickup: bool, optional
    :param call_monitoring: Specifies if monitoring of other extensions' calls is allowed for the extension. If 'CallMonitoring' feature is disabled for the given extension, the flag is not returned , defaults to None
    :type call_monitoring: bool, optional
    :param call_on_behalf_of: Specifies whether the current extension is able to make or receive calls on behalf of the user referenced in extension object , defaults to None
    :type call_on_behalf_of: bool, optional
    :param call_delegation: Specifies whether the current extension can delegate a call to the user referenced in extension object , defaults to None
    :type call_delegation: bool, optional
    :param group_paging: Specifies whether the current extension is allowed to call Paging Only group referenced to in extension object , defaults to None
    :type group_paging: bool, optional
    :param call_queue_setup: Specifies whether the current extension is assigned as a Full-Access manager in the call queue referenced in extension object , defaults to None
    :type call_queue_setup: bool, optional
    :param call_queue_members_setup: Specifies whether the current extension is assigned as a Members-Only manager in the call queue referenced in extension object , defaults to None
    :type call_queue_members_setup: bool, optional
    :param call_queue_messages: Specifies whether the current extension is assigned as a Messages Manager in the queue referenced in extension object , defaults to None
    :type call_queue_messages: bool, optional
    :param call_queue_fac_setup: Specifies whether the current extension is granted *Forward All Calls (FAC)* permission , defaults to None
    :type call_queue_fac_setup: bool, optional
    :param shared_voicemails: Specifies whether the user referenced in extension object is sharing voicemails with the current extension , defaults to None
