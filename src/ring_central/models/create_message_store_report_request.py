...
class CreateMessageStoreReportRequest(BaseModel):
    ...
    :param date_to: The end of the time range to collect message records in ISO 8601 format including timezone. Default is the current time , defaults to None
    :type date_to: str, optional
    :param date_from: The beginning of the time range to collect call log records in ISO 8601 format including timezone. Default is the current time minus 24 hours , defaults to None
