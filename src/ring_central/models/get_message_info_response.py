...
class GetMessageInfoResponse(BaseModel):
    ...
    :param conversation_id: SMS and Pager only. Identifier of a conversation the message belongs to , defaults to None
    ...
    :param fax_resolution: Fax only. Resolution of a fax message. 'High' for black and white image scanned at 200 dpi, 'Low' for black and white image scanned at 100 dpi , defaults to None
    ...
    :param last_modified_time: The date/time when the message was modified on server in ISO 8601 format including timezone, for example 2016-03-10T18:07:52.534Z , defaults to None
    ...
    :param pg_to_department: Pager only. `true` if at least one of the message recipients is 'Department' extension , defaults to None
    ...
    :param sms_delivery_time: SMS only. Date/time when outbound SMS was delivered to recipient's handset in ISO 8601 format including timezone, for example 2016-03-10T18:07:52.534Z. It is filled only if a carrier sends a delivery receipt to RingCentral , defaults to None
    :type sms_delivery_time: str, optional
    :param sms_sending_attempts_count: SMS only. Number of attempts made to send an outbound SMS to the Gateway (if Gateway is temporary unavailable) , defaults to None
    ...
    :param vm_transcription_status: Voicemail only. Status of a voicemail to text transcription. If 'VoicemailToText' feature is not activated for account, the 'NotAvailable' value is returned , defaults to None
    :type vm_transcription_status: VmTranscriptionStatus, optional
    :param cover_index: Cover page identifier. If coverIndex is set to '0' (zero) cover page is not attached. For the list of available cover page identifiers (1-13) please call the Fax Cover Pages method. If not specified, the default cover page is attached (which is configured in 'Outbound Fax Settings') , defaults to None
    :type cover_index: int, optional
    :param cover_page_text: Cover page text, entered by the fax sender and printed on the cover page. Maximum length is limited to 1024 symbols , defaults to None
