...
class BlacklistedData(BaseModel):
    ...
    :param blacklisted_at: Time of adding subscription to a black list in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format including timezone, for example *2016-03-10T18:07:52.534Z* , defaults to None
...
class SubscriptionInfo(BaseModel):
    ...
    :param disabled_filters: The list of event filter names corresponding to events the user is not subscribed to due to certain limitations , defaults to None
    :type disabled_filters: List[DisabledFilterInfo], optional
    :param expiration_time: Subscription expiration time in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format including timezone, for example *2016-03-10T18:07:52.534Z*
    ...
    :param creation_time: Subscription creation time in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format including timezone, for example *2016-03-10T18:07:52.534*
