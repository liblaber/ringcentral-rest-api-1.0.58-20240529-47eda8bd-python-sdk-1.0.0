...
class PersonalContactResourceAvailability(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                PersonalContactResourceAvailability._member_map_.values(),
            )
        )
...
class PersonalContactResource(BaseModel):
    """PersonalContactResource

    :param uri: Canonical URI of a contact, defaults to None
    :type uri: str, optional
    :param availability: This property has a special meaning only on Address Book Sync (e.g. a contact can be `Deleted`). For simple contact list reading it has always the default value - `Alive` , defaults to None
    :type availability: PersonalContactResourceAvailability, optional
    :param email: Email of a contact, defaults to None
    :type email: str, optional
    :param id_: Internal identifier of availability contact, defaults to None
    ...
    :param web_page: The contact home page URL, defaults to None
    ...
    :param email3: Third email of a contact, defaults to None
    ...
    :param business_phone: Business phone of the contact in e.164 (with "+") format, defaults to None
    ...
    :param mobile_phone: Mobile phone of a contact in e.164 (with "+") format, defaults to None
    ...
    :type business_address: ContactAddressInfo, optional
    :param home_address: home_address, defaults to None
    :type home_address: ContactAddressInfo, optional
    :param other_address: other_address, defaults to None
    :type other_address: ContactAddressInfo, optional
    :param ringtone_index: Contact ringtone. Max number of symbols is 64, defaults to None
    :type ringtone_index: str, optional
    """

    def __init__(
        self,
        uri: str = None,
        availability: PersonalContactResourceAvailability = None,
        email: str = None,
        id_: int = None,
        notes: str = None,
        company: str = None,
        ...
        business_address: ContactAddressInfo = None,
        home_address: ContactAddressInfo = None,
        other_address: ContactAddressInfo = None,
        ringtone_index: str = None,
    ):
        if uri is not None:
            self.uri = uri
        if availability is not None:
            self.availability = self._enum_matching(
                availability, PersonalContactResourceAvailability.list(), "availability"
            )
        ...
        if home_address is not None:
            self.home_address = self._define_object(home_address, ContactAddressInfo)
        if other_address is not None:
            self.other_address = self._define_object(other_address, ContactAddressInfo)
        if ringtone_index is not None:
            self.ringtone_index = ringtone_index
