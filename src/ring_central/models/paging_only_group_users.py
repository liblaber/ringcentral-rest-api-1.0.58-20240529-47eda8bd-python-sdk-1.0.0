...
@JsonMap({})
class PagingOnlyGroupUsers(BaseModel):
    """PagingOnlyGroupUsers

    :param uri: Link to a list of users allowed to page the Paging Only group , defaults to None
    :type uri: str, optional
    :param records: List of users allowed to page the Paging Only group, defaults to None
    :type records: List[PagingGroupExtensionInfo], optional
    ...
    def __init__(
        self,
        uri: str = None,
        records: List[PagingGroupExtensionInfo] = None,
        ...
        if records is not None:
            self.records = self._define_list(records, PagingGroupExtensionInfo)
