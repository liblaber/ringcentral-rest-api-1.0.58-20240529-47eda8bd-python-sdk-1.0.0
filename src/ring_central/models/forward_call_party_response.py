...
class ForwardCallPartyResponseDirection(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ForwardCallPartyResponseDirection._member_map_.values(),
            )
        )
...
class ForwardCallPartyResponseConferenceRole(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ForwardCallPartyResponseConferenceRole._member_map_.values(),
            )
        )
...
class ForwardCallPartyResponseRingOutRole(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ForwardCallPartyResponseRingOutRole._member_map_.values(),
            )
        )
...
class ForwardCallPartyResponseRingMeRole(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                ForwardCallPartyResponseRingMeRole._member_map_.values(),
            )
        )
...
class ForwardCallPartyResponse(BaseModel):
    ...
    def __init__(
        ...
        direction: ForwardCallPartyResponseDirection = None,
        conference_role: ForwardCallPartyResponseConferenceRole = None,
        ring_out_role: ForwardCallPartyResponseRingOutRole = None,
        ring_me_role: ForwardCallPartyResponseRingMeRole = None,
        ...
        if direction is not None:
            self.direction = self._enum_matching(
                direction, ForwardCallPartyResponseDirection.list(), "direction"
            )
        if conference_role is not None:
            self.conference_role = self._enum_matching(
                conference_role,
                ForwardCallPartyResponseConferenceRole.list(),
                "conference_role",
            )
        if ring_out_role is not None:
            self.ring_out_role = self._enum_matching(
                ring_out_role,
                ForwardCallPartyResponseRingOutRole.list(),
                "ring_out_role",
            )
        if ring_me_role is not None:
            self.ring_me_role = self._enum_matching(
                ring_me_role, ForwardCallPartyResponseRingMeRole.list(), "ring_me_role"
            )
