...
class SessionLivestreamMinimalModel(BaseModel):
    ...
    :param livestream_status: Last known state of the livestream as notified by Webinar Livestreaming Controller Service (WLCS). Value may not be consistent with latest state, especially for livestream associated with OAuth2.0 based service providers. Thus, state must be obtained directly from WLCS
    :type livestream_status: SessionLivestreamStatusModel
    :param previous_livestream_status: Last known state of the livestream as notified by Webinar Livestreaming Controller Service (WLCS). Value may not be consistent with latest state, especially for livestream associated with OAuth2.0 based service providers. Thus, state must be obtained directly from WLCS , defaults to None
