...
class PrivateIpRangeInfoRequest(BaseModel):
    ...
    :param emergency_address: Emergency address assigned to the switch. Only one of a pair `emergencyAddress` or `emergencyLocationId` should be specified, otherwise the error is returned , defaults to None
    :type emergency_address: LocationUpdatesEmergencyAddressInfoRequest, optional
    :param emergency_location_id: Emergency response location (address) internal identifier. Only one of a pair `emergencyAddress` or `emergencyLocationId` should be specified, otherwise the error is returned , defaults to None
