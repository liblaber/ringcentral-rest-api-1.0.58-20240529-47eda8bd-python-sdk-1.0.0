...
class CallMonitoringGroupMemberInfo(BaseModel):
    ...
    :param id_: Internal identifier of a call monitoring group member , defaults to None
    :type id_: str, optional
    :param extension_number: Extension number of a call monitoring group member , defaults to None
