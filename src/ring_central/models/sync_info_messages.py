...
class SyncInfoMessages(BaseModel):
    ...
    :param sync_type: Type of message synchronization request:   - FSync -- full sync   - ISync -- incremental sync , defaults to None
    :type sync_type: SyncTypeEnum, optional
    :param sync_token: Synchronization token, defaults to None
    :type sync_token: str, optional
    :param sync_time: Last synchronization date/time in ISO 8601 format including timezone, for example 2016-03-10T18:07:52.534Z , defaults to None
