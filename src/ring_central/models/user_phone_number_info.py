...
class UserPhoneNumberInfo(BaseModel):
    ...
    :param contact_center_provider: CCRN (Contact Center Routing Number) provider. If not specified then the default value 'InContact/North America' is used, its ID is '1' , defaults to None
    ...
    :param payment_type: Payment type. 'External' is returned for forwarded numbers which are not terminated in the RingCentral phone system , defaults to None
    :type payment_type: PlatformPaymentType, optional
    :param phone_number: Phone number, defaults to None
    :type phone_number: str, optional
    :param primary: Indicates if a phone number is primary, i.e. displayed as 'main number' and called by default , defaults to None
    :type primary: bool, optional
    :param status: Status of a phone number. If the value is 'Normal', the phone number is ready to be used. Otherwise, it is an external number not yet ported to RingCentral , defaults to None
    ...
    :param usage_type: Usage type of phone number. Numbers of 'NumberPool' type will not be returned for phone number list requests , defaults to None
