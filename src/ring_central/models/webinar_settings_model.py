...
class WebinarSettingsModel(BaseModel):
    ...
    :param recording_deletion_enabled: DEPRECATED AND REPLACED BY 'pastSessionDeletionEnabled' setting. Indicates if recording can be deleted (this setting is read-only at webinar/session level) , defaults to None
