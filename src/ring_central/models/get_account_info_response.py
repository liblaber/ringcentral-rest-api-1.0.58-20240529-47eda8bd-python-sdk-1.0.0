...
class GetAccountInfoResponse(BaseModel):
    ...
    :param bsid: Internal identifier of an account in the billing system , defaults to None
    :type bsid: str, optional
    :param main_number: Main phone number of the current account , defaults to None
    :type main_number: str, optional
    :param operator: Operator extension information. This extension will receive all calls and messages addressed to an operator. , defaults to None
    :type operator: AccountOperatorInfo, optional
    :param partner_id: Additional account identifier, created by partner application and applied on client side , defaults to None
    :type partner_id: str, optional
    :param service_info: Account service information, including brand, sub-brand, service plan and billing plan , defaults to None
    ...
    :param regional_settings: Account level region data (web service Auto-Receptionist settings) , defaults to None
    :type regional_settings: AccountRegionalSettings, optional
    :param federated: Specifies whether an account is included into any federation of accounts or not , defaults to None
    :type federated: bool, optional
    :param outbound_call_prefix: If outbound call prefix is not specified, or set to null (0), then the parameter is not returned; the supported value range is 2-9 , defaults to None
    :type outbound_call_prefix: int, optional
    :param cfid: Customer facing identifier. Returned for accounts with the turned off PBX features. Equals to main company number in [E.164](https://www.itu.int/rec/T-REC-E.164-201011-I) (without "+" sign)format , defaults to None
