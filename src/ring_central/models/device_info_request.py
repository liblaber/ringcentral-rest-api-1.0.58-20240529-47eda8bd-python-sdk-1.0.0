...
class DeviceInfoRequest(BaseModel):
    ...
    :param app_external_id: Supported for iOS devices only. Certificate name (used by iOS applications for APNS subscription) , defaults to None
    ...
    :param serial: Endpoint/device instance identifier for Softphone and mobile applications , defaults to None
