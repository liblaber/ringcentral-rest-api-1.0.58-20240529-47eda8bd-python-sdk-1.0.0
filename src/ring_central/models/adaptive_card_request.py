...
class AdaptiveCardRequest(BaseModel):
    ...
    :param type_: Type of attachment. This field is mandatory and filled on server side - will be ignored if set in request body
    :type type_: AdaptiveCardRequestType
    :param version: Version. This field is mandatory and filled on server side - will be ignored if set in request body
    :type version: str
