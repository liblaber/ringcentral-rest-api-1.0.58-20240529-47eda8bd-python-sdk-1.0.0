...
class WebhookDeliveryMode(BaseModel):
    ...
    :param address: The URL to which notifications should be delivered. This is only applicable for the `WebHook` transport type, for which it is a required field.
    :type address: str
