...
class PhoneNumberInfoConferencing(BaseModel):
    ...
    :param default: The value should be `true` if the number is default for the conference. Default conference number is a domestic number that can be set by user (otherwise it is set by the system). Only one default number per country is allowed , defaults to None
    :type default: bool, optional
    :param has_greeting: The value should be `true` if any greeting message is played on this number , defaults to None
    :type has_greeting: bool, optional
    :param location: Location (city, region, state) of a conference phone number , defaults to None
    :type location: str, optional
    :param phone_number: Dial-in phone number to connect to a conference, defaults to None
    :type phone_number: str, optional
    :param premium: Indicates if the number is 'premium' (account phone number with the `ConferencingNumber` usageType) , defaults to None
