...
class Contact(BaseModel):
    ...
    :param email_as_login_name: Indicates that contact email is enabled as login name for this user. Please note that email must be unique in this case. , defaults to None
...
class BatchProvisionUsersRequestItem(BaseModel):
    ...
    :param extension_number: Short number of an extension. Actual max length depends on system length limit for extension. , defaults to None
