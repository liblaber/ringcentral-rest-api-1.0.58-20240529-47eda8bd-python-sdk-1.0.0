...
class GetTokenRequest1(BaseModel):
    ...
    :param redirect_uri: For `authorization_code` grant type only. This is a callback URI which determines where the response is sent. The value of this parameter must exactly match one of the URIs you have provided for your app upon registration , defaults to None
    :type redirect_uri: str, optional
    :param code_verifier: For `authorization_code` grant type only. The code verifier as defined by  the PKCE specification - [RFC-7636 "Proof Key for Code Exchange by OAuth Public Clients"](https://datatracker.ietf.org/doc/html/rfc7636) , defaults to None
    :type code_verifier: str, optional
    :param client_assertion_type: Client assertion type for the `client_secret_jwt` or `private_key_jwt` client authentication types, as defined by [RFC-7523](https://datatracker.ietf.org/doc/html/rfc7523#section-2.2). This parameter is mandatory if the client authentication is required and a client decided to use one of these authentication types , defaults to None
    :type client_assertion_type: GetTokenRequest1ClientAssertionType, optional
    :param client_assertion: Client assertion (JWT) for the `client_secret_jwt` or `private_key_jwt` client authentication types, as defined by [RFC-7523](https://datatracker.ietf.org/doc/html/rfc7523#section-2.2). This parameter is mandatory if the client authentication is required and a client decided to use one of these authentication types , defaults to None
    :type client_assertion: str, optional
    :param scope: The list of application permissions (OAuth scopes) requested. By default, it includes all permissions configured on the client application registration , defaults to None
    :type scope: str, optional
    :param client_id: The registered identifier of a client application. Used to identify a client ONLY if the client authentication is not required and corresponding credentials are not provided with this request , defaults to None
    :type client_id: str, optional
    :param endpoint_id: The unique identifier of a client application instance. If not specified, the derived or auto-generated value will be used , defaults to None
...
class GetTokenRequest2(BaseModel):
    ...
    :param username: For `password` grant type only. User login name: email or phone number in E.164 format , defaults to None
    :type username: str, optional
    :param password: For `password` grant type only. User's password, defaults to None
    :type password: str, optional
    :param extension: For `password` grant type only. Optional. Extension short number. If a company number is specified as a username, and extension is not specified, the server will attempt to authenticate client as main company administrator DEPRECATED: use extension number embedded into username string like `+16501234567*101` , defaults to None
    :type extension: str, optional
    :param pin: IVR pin for pin-based authentication. DEPRECATED: use a dedicated `ivr_pin` grant type instead , defaults to None
...
class GetTokenRequest3(BaseModel):
    ...
    :param assertion: For `urn:ietf:params:oauth:grant-type:jwt-bearer` or `partner_jwt` grant types only. Authorization grant assertion (JWT) as defined by [RFC-7523](https://datatracker.ietf.org/doc/html/rfc7523#section-2.1). , defaults to None
...
class GetTokenRequest4(BaseModel):
    ...
    :param refresh_token: For `refresh_token` grant type only. Previously issued refresh token. , defaults to None
...
class GetTokenRequest6(BaseModel):
    ...
    :param device_code: For `urn:ietf:params:oauth:grant-type:device_code` grant type only. The device verification code as defined by [RFC-8628](https://datatracker.ietf.org/doc/html/rfc8628#section-3.4) , defaults to None
...
class GetTokenRequest8(BaseModel):
    ...
    :param code: For `otp` grant type only. One-time password code , defaults to None
    :type code: str, optional
    :param client_assertion_type: Client assertion type for the `client_secret_jwt` or `private_key_jwt` client authentication types, as defined by [RFC-7523](https://datatracker.ietf.org/doc/html/rfc7523#section-2.2). This parameter is mandatory if the client authentication is required and a client decided to use one of these authentication types , defaults to None
