...
class ExtensionCreationResponse(BaseModel):
    ...
    :param service_features: Extension service features returned in response only when the logged-in user requests his/her own extension info, see also Extension Service Features , defaults to None
    ...
    :param hidden: Hides an extension from showing in company directory. Supported for extensions of 'User' type only , defaults to None
