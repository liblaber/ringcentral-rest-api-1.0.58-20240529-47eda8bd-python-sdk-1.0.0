...
class SessionResource(BaseModel):
    ...
    :param start_time: Session start time. If a session hasn't been started this fields should be set to "scheduledStartTime" , defaults to None
    :type start_time: str, optional
    :param end_time: Session end time. If a session hasn't been finished this fields should be set to ("startTime"+"scheduledDuration") , defaults to None
    ...
    :param panel_join_time_offset: The time offset (positive, in seconds) indicating how much in advance (comparing to "scheduledStartTime") panel members should join for the pre-webinar team sync , defaults to None
    ...
    :param runtime_status: Session runtime status (for 'Active' Sessions only). It is omitted (or null) if the status is not Active , defaults to None
    ...
    :type recording: RecordingExtendedModel, optional
    ...
    def __init__(
        ...
        recording: RecordingExtendedModel = None,
        ...
        if recording is not None:
            self.recording = self._define_object(recording, RecordingExtendedModel)
