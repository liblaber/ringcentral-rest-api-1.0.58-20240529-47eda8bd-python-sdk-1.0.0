...
class CreateFaxMessageRequest(BaseModel):
    ...
    :param send_time: Timestamp to send a fax at. If not specified, current or the past a fax message is sent immediately , defaults to None
    :type send_time: str, optional
    :param iso_code: Alpha-2 ISO Code of a country, defaults to None
    :type iso_code: str, optional
    :param cover_index: Cover page identifier. If `coverIndex` is set to '0' (zero) a cover page is not attached. For a list of available cover page identifiers (1-13) please call the Fax Cover Pages method. If not specified, the default cover page is attached (which is configured in 'Outbound Fax Settings') , defaults to None
    :type cover_index: int, optional
    :param cover_page_text: Cover page text, entered by a fax sender and printed on a cover page. Maximum length is limited to 1024 symbols , defaults to None
