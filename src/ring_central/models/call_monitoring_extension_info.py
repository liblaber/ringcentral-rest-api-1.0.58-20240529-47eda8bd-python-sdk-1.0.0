...
class CallMonitoringExtensionInfo(BaseModel):
    ...
    :param id_: Internal identifier of an extension. Only the following extension types are allowed: User, DigitalUser, VirtualUser, FaxUser, Limited , defaults to None
    :type id_: str, optional
    :param permissions: Set of call monitoring group permissions granted to a specified extension. In order to remove a specified extension from a call monitoring group use an empty value , defaults to None
