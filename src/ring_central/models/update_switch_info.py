...
class UpdateSwitchInfo(BaseModel):
    ...
    :param chassis_id: Unique identifier of a network switch. The supported formats are: XX:XX:XX:XX:XX:XX (symbols 0-9 and A-F) for MAC address and X.X.X.X for IP address (symbols 0-255) , defaults to None
