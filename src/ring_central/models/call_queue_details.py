...
class CallQueueDetails(BaseModel):
    ...
    :param alert_timer: Alert timer or pickup setting. Delay time in seconds before call queue group members are notified when calls are queued , defaults to None
