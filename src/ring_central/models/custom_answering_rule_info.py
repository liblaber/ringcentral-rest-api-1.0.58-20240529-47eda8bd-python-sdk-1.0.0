...
class CustomAnsweringRuleInfoType(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, CustomAnsweringRuleInfoType._member_map_.values())
        )
...
class CustomAnsweringRuleInfoCallHandlingAction(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                CustomAnsweringRuleInfoCallHandlingAction._member_map_.values(),
            )
        )
...
class CustomAnsweringRuleInfoScreening(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                CustomAnsweringRuleInfoScreening._member_map_.values(),
            )
        )
...
class CustomAnsweringRuleInfo(BaseModel):
    ...
    :type type_: CustomAnsweringRuleInfoType, optional
    ...
    :type call_handling_action: CustomAnsweringRuleInfoCallHandlingAction, optional
    ...
    :param unconditional_forwarding: Unconditional forwarding parameters. Returned if 'UnconditionalForwarding' value is specified for the `callHandlingAction` parameter , defaults to None
    :type unconditional_forwarding: UnconditionalForwardingInfo, optional
    :param queue: Queue settings applied for department (call queue) extension type, with the 'AgentQueue' value specified as a call handling action , defaults to None
    ...
    :type screening: CustomAnsweringRuleInfoScreening, optional
    ...
    def __init__(
        ...
        uri: str = None,
        id_: str = None,
        type_: CustomAnsweringRuleInfoType = None,
        name: str = None,
        enabled: bool = None,
        schedule: ScheduleInfo = None,
        called_numbers: List[CalledNumberInfo] = None,
        callers: List[CallersInfo] = None,
        call_handling_action: CustomAnsweringRuleInfoCallHandlingAction = None,
        ...
        screening: CustomAnsweringRuleInfoScreening = None,
        ...
        if type_ is not None:
            self.type_ = self._enum_matching(
                type_, CustomAnsweringRuleInfoType.list(), "type_"
            )
        if name is not None:
            self.name = name
        ...
        if call_handling_action is not None:
            self.call_handling_action = self._enum_matching(
                ...
                CustomAnsweringRuleInfoCallHandlingAction.list(),
                "call_handling_action",
            )
        ...
        if screening is not None:
            self.screening = self._enum_matching(
                screening, CustomAnsweringRuleInfoScreening.list(), "screening"
            )
