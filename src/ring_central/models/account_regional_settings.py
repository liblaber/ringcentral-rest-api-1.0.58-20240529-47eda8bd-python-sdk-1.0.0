...
class AccountRegionalSettingsTimeFormat(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                AccountRegionalSettingsTimeFormat._member_map_.values(),
            )
        )
...
class AccountRegionalSettings(BaseModel):
    ...
    :param greeting_language: Information on language used for telephony greetings , defaults to None
    :type greeting_language: GreetingLanguageInfo, optional
    :param formatting_locale: Formatting language preferences for numbers, dates and currencies , defaults to None
    ...
    :type time_format: AccountRegionalSettingsTimeFormat, optional
    :param currency: Currency information, defaults to None
    :type currency: CurrencyInfo, optional
    """
    ...
    def __init__(
        ...
        time_format: AccountRegionalSettingsTimeFormat = None,
        ...
        if time_format is not None:
            self.time_format = self._enum_matching(
                time_format, AccountRegionalSettingsTimeFormat.list(), "time_format"
            )
        if currency is not None:
            self.currency = self._define_object(currency, CurrencyInfo)
