...
class NotificationSettings(BaseModel):
    ...
    :param email_recipients: List of extensions specified as email notification recipients. Returned only for call queues where queue managers are assigned as user extensions. , defaults to None
    :type email_recipients: List[EmailRecipientInfo], optional
    :param email_addresses: List of notification recipient email addresses , defaults to None
    :type email_addresses: List[str], optional
    :param include_managers: Specifies if managers' emails are included in the list of emails to which notifications are sent , defaults to None
