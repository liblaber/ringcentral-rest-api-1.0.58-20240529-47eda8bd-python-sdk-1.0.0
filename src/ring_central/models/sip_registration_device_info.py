...
class SipRegistrationDeviceInfo(BaseModel):
    ...
    :param name: Device name. Mandatory if ordering  SoftPhone or OtherPhone. Optional for HardPhone. If not specified for HardPhone, then device  model  name is used as device  name , defaults to None
    :type name: str, optional
    :param serial: Serial number for HardPhone (is returned only when the phone is shipped and provisioned); endpoint_id for Softphone and mobile applications , defaults to None
    ...
    :param box_billing_id: Box billing identifier of a device. Applicable only for devices of `HardPhone` type. , defaults to None
    ...
    :param last_location_report_time: Timestamp of receiving last location report in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format including timezone, for example *2016-03-10T18:07:52.534Z , defaults to None
