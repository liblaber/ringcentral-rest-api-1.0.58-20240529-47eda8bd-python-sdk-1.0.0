...
class WcsWebinarSettingsModelPanelistAuthentication(Enum):
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                WcsWebinarSettingsModelPanelistAuthentication._member_map_.values(),
            )
        )


class WcsWebinarSettingsModelAttendeeAuthentication(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                WcsWebinarSettingsModelAttendeeAuthentication._member_map_.values(),
            )
        )


class WcsWebinarSettingsModelArtifactsAccessAuthentication(Enum):
    """An enumeration representing different categories.
    ...
    def list():
        ...
        return list(
            map(
                lambda x: x.value,
                WcsWebinarSettingsModelArtifactsAccessAuthentication._member_map_.values(),
            )
        )
...
class WcsWebinarSettingsModel(BaseModel):
    ...
    :param recording_sharing_enabled: Indicates if recording can be shared (this setting is read-only at webinar level), defaults to None
    :type recording_sharing_enabled: bool, optional
    :param recording_download_enabled: Indicates if recording can be downloaded (this setting is read-only at webinar level), defaults to None
    :type recording_download_enabled: bool, optional
    :param recording_deletion_enabled: DEPRECATED AND REPLACED BY 'pastSessionDeletionEnabled' setting. Indicates if recording can be deleted (this setting is read-only at webinar level) , defaults to None
    :type recording_deletion_enabled: bool, optional
    :param past_session_deletion_enabled: Indicates if deletion of past session along with its artifacts is enabled for Host. This setting is read-only at webinar level , defaults to None
    ...
    :type panelist_authentication: WcsWebinarSettingsModelPanelistAuthentication, optional
    :param attendee_authentication: Indicates if attendees have to be authenticated users, defaults to None
    :type attendee_authentication: WcsWebinarSettingsModelAttendeeAuthentication, optional
    :param artifacts_access_authentication: Indicates who can access webinar artifacts. Applies to recordings at present. Applicable to other artifacts such as Q&A, Polls in the future. , defaults to None
    :type artifacts_access_authentication: WcsWebinarSettingsModelArtifactsAccessAuthentication, optional
    :param pstn_enabled: Indicates if dial-in PSTN audio option is enabled for Panelists, defaults to None
    :type pstn_enabled: bool, optional
    :param password: Webinar password. If company-level "passwordEnabled" is true and "password" is null / omitted, the backend generates the password , defaults to None
    ...
    def __init__(
        ...
        panelist_authentication: WcsWebinarSettingsModelPanelistAuthentication = None,
        attendee_authentication: WcsWebinarSettingsModelAttendeeAuthentication = None,
        artifacts_access_authentication: WcsWebinarSettingsModelArtifactsAccessAuthentication = None,
        ...
        if artifacts_access_authentication is not None:
            self.artifacts_access_authentication = self._enum_matching(
                ...
                WcsWebinarSettingsModelArtifactsAccessAuthentication.list(),
                "artifacts_access_authentication",
            )
