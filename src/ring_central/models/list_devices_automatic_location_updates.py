...
@JsonMap({})
class ListDevicesAutomaticLocationUpdates(BaseModel):
    """ListDevicesAutomaticLocationUpdates

    :param uri: Link to a devices resource, defaults to None
    :type uri: str, optional
    :param records: List of the user(s) devices with the current status of Emergency Address Auto Update Feature , defaults to None
    :type records: List[AutomaticLocationUpdatesDeviceInfo], optional
    ...
    def __init__(
        self,
        uri: str = None,
        records: List[AutomaticLocationUpdatesDeviceInfo] = None,
