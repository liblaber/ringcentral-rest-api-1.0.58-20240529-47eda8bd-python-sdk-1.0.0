...
class CallLogRecordTransferTarget(BaseModel):
...
@JsonMap({"telephony_session_id": "telephonySessionId"})
class CallLogRecordTransferee(BaseModel):
...
class CallLogRecord(BaseModel):
    ...
    :type transfer_target: CallLogRecordTransferTarget, optional
    :param transferee: transferee, defaults to None
    :type transferee: CallLogRecordTransferee, optional
    :param party_id: Internal Identifier of Participant, defaults to None
    :type party_id: str, optional
    :param transport: The type of call transport. 'PSTN' indicates that a call leg was initiated from the PSTN network provider; 'VoIP' - from an RC phone. , defaults to None
    ...
    :param id_: Internal identifier of a call log record
    :type id_: str
    :param uri: Canonical URI of a call log record
    :type uri: str
    :param session_id: Internal identifier of a call session
    :type session_id: str
    :param deleted: Indicates whether the record is deleted. Returned for deleted records, for ISync requests, defaults to None
    :type deleted: bool, optional
    :param legs: For 'Detailed' view only. Leg description, defaults to None
    :type legs: List[CallLogRecordLegInfo], optional
    :param last_modified_time: For 'Detailed' view only. The datetime when the call log record was modified in ```(ISO 8601)[https://en.wikipedia.org/wiki/ISO_8601]``` format including timezone, for example ```*2016-03-10T18:07:52.534Z*``` , defaults to None
    ...
    def __init__(
        ...
        transfer_target: CallLogRecordTransferTarget = None,
        transferee: CallLogRecordTransferee = None,
        party_id: str = None,
        ...
        deleted: bool = None,
        legs: List[CallLogRecordLegInfo] = None,
        ...
        if transferee is not None:
            self.transferee = self._define_object(transferee, CallLogRecordTransferee)
        ...
        if legs is not None:
            self.legs = self._define_list(legs, CallLogRecordLegInfo)
