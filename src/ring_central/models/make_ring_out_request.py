...
class MakeRingOutRequest(BaseModel):
    ...
    :param from_: Phone number of a caller. This number corresponds to the 1st leg of a RingOut call. This number can be one of the user's configured forwarding numbers or an arbitrary number
    :type from_: MakeRingOutCallerInfoRequestFrom
    :param to: Phone number of a called party. This number corresponds to the 2nd leg of a RingOut call
    ...
    :param play_prompt: Audio prompt that a calling party hears when a call is connected , defaults to None
    :type play_prompt: bool, optional
    :param country: Optional. Dialing plan country data. If not specified, then an extension home country is applied by default , defaults to None
