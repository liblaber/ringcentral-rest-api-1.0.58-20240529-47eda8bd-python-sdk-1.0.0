...
class ProfileImageInfo(BaseModel):
    ...
    :param uri: Link to a profile image. If an image is not uploaded for an extension, only `uri` is returned
    :type uri: str
    :param etag: Identifier of an image, defaults to None
    :type etag: str, optional
    :param last_modified: Date/time when an image was last updated, in ISO 8601 format, for example 2016-03-10T18:07:52.534Z , defaults to None
    :type last_modified: str, optional
    :param content_type: The type of image, defaults to None
    :type content_type: str, optional
    :param scales: List of URIs to profile images in different dimensions , defaults to None
